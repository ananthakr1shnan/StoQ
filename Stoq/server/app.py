...
def chat():
    ...
    try:
        ...
        print(f"Using Groq to generate response for {ticker.text}...")
    ...
    # Replace Perplexity chat completion with Groq
    ...
    return {
        ...
        "citations": getattr(response, 'citations', None)  # Groq might handle citations differently
    }
